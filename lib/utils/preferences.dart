...
class Preferences {
  ...
  static init() async {
    if (kIsWeb || Platform.isIOS || Platform.isAndroid || Platform.isMacOS) {
      ...
      Config.greenMiniCount =
          Preferences.getInt(Constants.GREEN_MINI_COUNT, 50);
      Config.yellowMiniCount =
          Preferences.getInt(Constants.YELLOW_MINI_COUNT, 20);
      Config.greyMiniCount = Preferences.getInt(Constants.GREY_MINI_COUNT, 0);
    }
  }
